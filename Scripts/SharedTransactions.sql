/*
    Intro: This SQL query is used to get shared transactions by decending order of created order.
...
where 	(shared_transaction.sender_id = @userId || shared_transaction.receiver_id = @userId) &&
		...
		transaction.transaction_spent_for_id = @transactionSpentFor
