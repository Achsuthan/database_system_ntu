...
SET @userId = 1;
SET @transactionSpentFor = 1; -- own


SELECT transaction.transaction_id as transaction_id, transaction.name as transaction_name, transaction.amount as transaction_amount ,transaction.description as transaction_description,
 transaction.updateddate as transaction_created_date, transaction.is_bank_transaction as is_bank_transaction,
