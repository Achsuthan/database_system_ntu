...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`mysqladmin`@`%`*/ /*!50003 TRIGGER `moneymanager`.`group_transaction_BEFORE_INSERT` BEFORE INSERT ON `group_transaction` FOR EACH ROW
BEGIN
...
-- Dump completed on 2022-03-20  2:00:11
